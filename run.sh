...
nasm "Src/ASM/signature.asm" -f bin -o "Binaries/signature.bin"
...
i386-elf-gcc -ffreestanding -m32 -g -IInclude -c "Src/C/Speaker.cpp" -o "Binaries/Speaker.o"
...
i386-elf-ld -o "Binaries/full_kernel.bin" -Ttext 0x10000 "Binaries/kernel_entry.o" "Binaries/kernel.o" "Binaries/VGA.o" "Binaries/IO.o" "Binaries/Keyboard.o" "Binaries/Disk.o" "Binaries/CommandProcessor.o" "Binaries/Util.o" "Binaries/Speaker.o" --oformat binary
...
sh sectorAmmount.sh "Binaries/testSector.bin"
